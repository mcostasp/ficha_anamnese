...
-- AddForeignKey
ALTER TABLE "customer"."form" ADD CONSTRAINT "form_service_id_fkey" FOREIGN KEY ("service_id") REFERENCES "core"."services"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "customer"."service" ADD CONSTRAINT "service_service_id_fkey" FOREIGN KEY ("service_id") REFERENCES "core"."services"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
